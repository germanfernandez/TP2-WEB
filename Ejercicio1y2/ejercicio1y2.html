            ...
            <fieldset>
                <section>
                    ...
                    <article>
                        ...
                        <input type="text" id="nombre" name="nombre" maxlength="20" pattern="[A-Za-zÀ-ž\s]{2,}" placeholder="Ingrese su nombre"  required> *
                    </article>
                    ...
                    <input type="number" id="edad" name="edad"  min="1" max="105" placeholder="Rango válido [0-105]">
